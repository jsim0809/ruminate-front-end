    ...
    <div className="answer-block" key={answer._id}>
      <div className="answer-left-line">
        ...
        <div className="answer-header">
          Response from {answer.author.username} | Reviewed this property | <span><img className="large-flag" src="http://localhost:3004/images/flag-icon.png" onClick={handleLoginClick} /><span className="flag-tooltip">Problem with this answer?</span></span>
        </div>
