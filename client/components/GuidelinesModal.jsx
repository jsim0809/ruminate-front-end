...
/**
 * Modal that pops up when "Posting guidelines" is clicked.
 * Parent: QA
 * Children: none
 */
const GuidelinesModal = ({ restaurantID, handleGuidelinesCancelClick }) => (
  ...
  <div className="modal-background">
    ...
    <div className="modal-guidelines">
      {/* Cancel button */}
      <div className="modal-x-button" onClick={handleGuidelinesCancelClick} onKeyDown={handleGuidelinesCancelClick} role="button">&#x1F5D9;</div>
      {/* Box text */}
      ...
      <ul>
        ...
        <li className="guidelines-list-element">
          {'If you have a customer service issue, please contact the business directly. For questions about visiting a destination, check out '}
          <a href={`/${restaurantID}/`}>Tripadvisor Forums</a>
          .
        </li>
        ...
        <li className="guidelines-list-element">
          ...
          <a href={`/${restaurantID}/`}>Questions and Answers Guidelines</a>
          .
        </li>
      </ul>
    </div>
